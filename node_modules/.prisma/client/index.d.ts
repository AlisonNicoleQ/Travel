...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'admin' | 'cliente' | 'destinos' | 'eventos' | 'idiomas' | 'itinerario' | 'pagos' | 'recuperacionContrasena' | 'review' | 'reservas' | 'servicios' | 'tipo_evento' | 'tipo_moneda' | 'tipo_servicio'
